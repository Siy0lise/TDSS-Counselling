...
public class ClientLogin extends AppCompatActivity {
    ...
    public void LOGIN(View view)
    {
        ...
        post("https://lamp.ms.wits.ac.za/home/s2672925/clientsLogin.php", username, password, new Callback() {
            @Override
    ...
    private void processJSON(String response) {
        try {
            ...
            String userLog = u.getText().toString();
            if (message.equalsIgnoreCase("Success")) {
                Intent intent = new Intent(ClientLogin.this, ClientProfile2.class);
